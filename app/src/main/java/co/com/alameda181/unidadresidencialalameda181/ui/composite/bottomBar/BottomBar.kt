package co.com.alameda181.unidadresidencialalameda181.ui.composite.bottomBar
...
fun BottomBar(navigation:NavController){
    ...
    BottomNavigation (
        ...
        BottomNavigationItem(
            ...
            icon = { Icon(painterResource(id = R.drawable.whatsap_7272),contentDescription = "") }
        ...
        BottomNavigationItem(
            ...
            onClick = {
                ...
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                intent.putExtra(Intent.EXTRA_EMAIL, "Buenos Dias")
